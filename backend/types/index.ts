...
export type RoomStatus = "lobby" | "live" | "paused" | "ended" | "transition" | "analysing";
...
export interface TeamSquadSelection {
  playingXI: PlayingXIPlayer[];
...
export interface RoomState {
  ...
  playingXIIs: Record<string, TeamSquadSelection>; // teamCode -> selection
  lockedTeams: string[];                 // teamCodes that have confirmed their Playing XII
}
...
export interface SubmitPlayingXIIPayload {
  roomCode: string;
  teamCode: string;
  sessionId: string;
  playingXI: PlayingXIPlayer[];
...
export interface UnlockPlayingXIIPayload {
  roomCode: string;
  teamCode: string;
  sessionId: string;
}
